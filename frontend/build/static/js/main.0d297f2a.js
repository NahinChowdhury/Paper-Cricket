/*! For license information please see main.0d297f2a.js.LICENSE.txt */
(() => {
	"use strict";
	var e = {
			43: (e, t, n) => {
			...
			730: (e, t, n) => {
				...
				function Be(e, t, n, r, o, a, i, l, s) {
					((Fe = !1), (je = null), Ae.apply(Ue, arguments));
				}
				function Ve(e) {
					var t = e,
						n = e;
				...
				function Xa(e, t) {
					switch (
						(To(Ka, t), To(Qa, e), To(qa, Ha), (e = t.nodeType))
					) {
						case 9:
						case 11:
				...
				function Ci(e, t, n, r) {
					((t.value = n), (t.getSnapshot = r), Pi(t) && Ri(e));
				}
				function Ti(e, t, n) {
					return n(function () {
						Pi(t) && Ri(e);
							...
							return (
								(n =
									null !== n && void 0 !== n
										? n.concat([e])
										: null),
								zi(4194308, 4, Ii.bind(null, t, e), n)
							);
						},
				...
				function ll(e, t, n, r) {
					((e = t.state),
						...
						t.state !== e &&
							ol.enqueueReplaceState(t, t.state, null));
				}
				function sl(e, t, n, r) {
					var o = e.stateNode;
					((o.props = n),
					...
					("object" === typeof a && null !== a
						...
						"function" === typeof t.getDerivedStateFromProps ||
							...
							t !== o.state &&
								ol.enqueueReplaceState(o, o.state, null),
							$a(e, n, o, r),
							(o.state = e.memoizedState)),
				...
				function ml(e, t, n) {
					...
					if (null === r) {
						...
						void 0 === (o = r.get(t)) &&
							((o = new Set()), r.set(t, o));
					o.has(n) ||
						(o.add(n), (e = Eu.bind(null, e, t, n)), t.then(e, e));
				}
				function gl(e) {
					do {
						var t;
				...
				function wl(e, t, n, r) {
					t.child =
						null === e ? Sa(t, null, n, r) : ka(t, e.child, n, r);
				}
				...
				function Sl(e, t, n, r, o) {
					if (null === e) {
						...
						return "function" !== typeof a ||
							...
							? (((e = Mu(n.type, null, r, t, t.mode, o)).ref =
									t.ref),
								(e.return = t),
								(t.child = e))
				...
				function Tl(e, t, n, r, o) {
					...
					if ((Na(t, o), null === t.stateNode))
						...
						((i.state = d),
							$a(t, r, i, o),
							(s = t.memoizedState),
							l !== r || d !== s || No.current || Fa
								? ("function" === typeof c &&
										(rl(t, n, c, r), (s = t.memoizedState)),
									(l = Fa || al(t, n, l, r, d, s, u))
										? (f ||
												("function" !==
						...
						l !== f || d !== h || No.current || Fa
							? ("function" === typeof p &&
									(rl(t, n, p, r), (h = t.memoizedState)),
								(u = Fa || al(t, n, u, r, d, h, s) || !1)
									? (c ||
											("function" !==
				...
				function Vl(e, t, n) {
					...
					if ((To(ei, r), 0 === (1 & t.mode))) t.memoizedState = null;
					else
						switch (o) {
							case "forwards":
				...
				function Ql(e, t, n) {
					...
					switch ((na(t), t.tag)) {
						...
						case 19:
							if ((Co(ei), null === (i = t.memoizedState)))
								return (ql(t), null);
							if (
								((r = 0 !== (128 & t.flags)),
								null === (s = i.rendering))
				...
				function su(e) {
					...
					if (1 === n)
						throw ((n = As), du(e, 0), lu(e, t), ru(e, Je()), n);
				...
				function hu() {
					var e = Es.current;
					return ((Es.current = Gi), null === e ? Gi : e);
				}
				function mu() {
					((0 !== Ms && 3 !== Ms && 2 !== Ms) || (Ms = 4),
						null === Rs ||
				...
				function gu(e, t) {
					...
					if ((Ta(), (Ps = n), (Es.current = r), null !== Ns))
						throw Error(a(261));
					return ((Rs = null), (Os = 0), Ms);
				}
				function yu() {
					for (; null !== Ns; ) bu(Ns);
				}
				...
				function Mu(e, t, n, r, o, i) {
					...
					if (((r = e), "function" === typeof e)) Lu(e) && (l = 1);
						...
						e: switch (e) {
							...
							case E:
								return (
									((e = Ou(12, n, t, 2 | o)).elementType = E),
									(e.lanes = i),
									e
								);
							case R:
								return (
									((e = Ou(13, n, t, o)).elementType = R),
									(e.lanes = i),
									e
								);
							case N:
				...
				function Vu(e, t, n, r, o, a, i, l, s) {
					return (
						((e = Uu(n, r, !0, e, 0, a, 0, l, s)).context =
							Bu(null)),
						(n = e.current),
	...
	function v(e, t, n, r) {
		...
		null == p && ((p = 0), l.replaceState(c({}, l.state, { idx: p }), ""));
		let w = {
			get action() {
				return s;
			},
			...
			listen(e) {
				...
				return (
					a.addEventListener(f, v),
					(u = e),
					() => {
						(a.removeEventListener(f, v), (u = null));
					}
				);
			},
			createHref: (e) => t(a, e),
	...
	function k(e, t, n, r) {
		let o = A(("string" === typeof t ? y(t) : t).pathname || "/", n);
	...
	function O(e, t) {
		...
		return (
			...
			n
				.filter((e) => !N(e))
				.reduce((e, t) => e + (x.test(t) ? E : "" === t ? T : P), r)
		);
	}
	function L(e, t, n) {
		void 0 === n && (n = !1);
	...
	function z(e, t) {
		...
		let a = o[0],
			...
			s = r.reduce((e, t, n) => {
				...
				const s = l[n];
				return (
					(e[r] = o && !s ? void 0 : (s || "").replace(/%2F/g, "/")),
					e
				);
			}, {});
		return { params: s, pathname: a, pathnameBase: i, pattern: e };
	}
	function M(e) {
		try {
			return e
		...
		let s = (function (e, t) {
				...
				let {
					...
					a = n
						...
						: t;
				return { pathname: a, search: V(r), hash: $(o) };
			})(o, a),
			u = l && "/" !== l && l.endsWith("/"),
			f = (i || "." === l) && n.endsWith("/");
		return (
			s.pathname.endsWith("/") || (!u && !f) || (s.pathname += "/"),
			s
		);
	}
	...
	function te() {
		return (ee() || d(!1), a.useContext(J).location);
	}
	function ne(e) {
		a.useContext(X).static || a.useLayoutEffect(e);
	}
	function re() {
	...
	function ae(e, t, n, r) {
		ee() || d(!1);
		let { navigator: i } = a.useContext(X),
	...
	const le = a.createElement(ie, null);
	...
	function ce(e, t, n, r) {
		...
		if (null != s) {
			let e = l.findIndex(
				(e) =>
					e.route.id &&
					void 0 !== (null == s ? void 0 : s[e.route.id]),
			);
			(e >= 0 || d(!1), (l = l.slice(0, Math.min(l.length, e + 1))));
		}
		let u = !1,
			c = -1;
		if (n && r && r.v7_partialHydration)
			for (let a = 0; a < l.length; a++) {
				let e = l[a];
				if (
					((e.route.HydrateFallback ||
						e.route.hydrateFallbackElement) &&
						(c = a),
					e.route.id)
				) {
		...
		return (
			a.Children.forEach(e, (e, r) => {
				...
				if (e.type === a.Fragment)
					return void n.push.apply(n, ke(e.props.children, o));
				(e.type !== ve && d(!1),
	...
	const ze = { type: "error", data: "parser error" },
		Me =
		...
		je = (e, t, n) => {
			let { type: r, data: o } = e;
			return Me && o instanceof Blob
				? t
					? n(o)
					: De(o, n)
				: Ae && (o instanceof ArrayBuffer || Fe(o))
					? t
						? n(o)
						: De(new Blob([o]), n)
					: n(Oe[r] + (o || ""));
	...
	for (let vn = 0; vn < 64; vn++) Ve[Be.charCodeAt(vn)] = vn;
	const $e = "function" === typeof ArrayBuffer,
		We = (e, t) => {
			if ("string" !== typeof e)
				return { type: "message", data: qe(e, t) };
			const n = e.charAt(0);
			if ("b" === n)
				return { type: "message", data: He(e.substring(1), t) };
			return Le[n]
				? e.length > 1
					? { type: Le[n], data: e.substring(1) }
					: { type: Le[n] }
				: ze;
		},
		He = (e, t) => {
			if ($e) {
				const n = ((e) => {
					...
					for (t = 0; t < l; t += 4)
						((n = Ve[e.charCodeAt(t)]),
							(r = Ve[e.charCodeAt(t + 1)]),
							(o = Ve[e.charCodeAt(t + 2)]),
							(a = Ve[e.charCodeAt(t + 3)]),
							(c[s++] = (n << 2) | (r >> 4)),
							(c[s++] = ((15 & r) << 4) | (o >> 2)),
							(c[s++] = ((3 & o) << 6) | (63 & a)));
					return u;
	...
	function Ke() {
		return new TransformStream({
			transform(e, t) {
				!(function (e, t) {
					Me && e.data instanceof Blob
						? e.data.arrayBuffer().then(Ie).then(t)
						: Ae && (e.data instanceof ArrayBuffer || Fe(e.data))
							? t(Ie(e.data))
							: je(e, !1, (e) => {
									(Ue || (Ue = new TextEncoder()),
										t(Ue.encode(e)));
								});
				})(e, (n) => {
					const r = n.length;
	...
	function Ge(e) {
		if (e)
			return (function (e) {
				for (var t in Ge.prototype) e[t] = Ge.prototype[t];
				return e;
			})(e);
	}
	...
	const nt = et.setTimeout,
		rt = et.clearTimeout;
	function ot(e, t) {
		t.useNativeTimers
			? ((e.setTimeoutFn = nt.bind(et)), (e.clearTimeoutFn = rt.bind(et)))
			: ((e.setTimeoutFn = et.setTimeout.bind(et)),
				(e.clearTimeoutFn = et.clearTimeout.bind(et)));
	}
	function at(e) {
	...
	class st extends Ge {
		...
		onError(e, t, n) {
			return (super.emitReserved("error", new lt(e, t, n)), this);
		}
		open() {
		...
		onData(e) {
			const t = We(e, this.socket.binaryType);
			this.onPacket(t);
		}
		onPacket(e) {
	...
	class ht extends Ge {
		...
		_create() {
			...
			"undefined" !== typeof document &&
				((this._index = ht.requestsCount++),
				(ht.requests[this._index] = this));
		}
		_onError(e) {
		...
		_cleanup(e) {
			if ("undefined" !== typeof this._xhr && null !== this._xhr) {
				if (((this._xhr.onreadystatechange = dt), e))
					try {
						this._xhr.abort();
					} catch (gn) {}
				("undefined" !== typeof document &&
					delete ht.requests[this._index],
					(this._xhr = null));
			}
		}
		_onLoad() {
	...
	if (
		...
		if ("function" === typeof attachEvent) attachEvent("onunload", mt);
			...
			addEventListener(
				"onpagehide" in et ? "pagehide" : "unload",
				mt,
				!1,
			);
		}
	function mt() {
		for (let e in ht.requests)
			ht.requests.hasOwnProperty(e) && ht.requests[e].abort();
	}
	const gt = (function () {
		const e = yt({ xdomain: !1 });
		return e && null !== e.responseType;
	})();
	function yt(e) {
		const t = e.xdomain;
		try {
			if ("undefined" !== typeof XMLHttpRequest && (!t || ft))
				return new XMLHttpRequest();
		} catch (gn) {}
		if (!t)
			try {
				return new et[["Active"].concat("Object").join("X")](
					"Microsoft.XMLHTTP",
				);
			} catch (gn) {}
	}
	...
	class bt extends st {
		...
		doOpen() {
			...
			try {
				...
				return this.emitReserved("error", yn);
			}
	...
	const wt = et.WebSocket || et.MozWebSocket;
	const kt = {
			websocket: class extends bt {
				createSocket(e, t, n) {
					return vt ? new wt(e, t, n) : t ? new wt(e, t) : new wt(e);
				}
				doWrite(e, t) {
					this.ws.send(t);
				}
			},
			webtransport: class extends st {
				get name() {
					return "webtransport";
				}
				doOpen() {
	...
	class Tt extends Ge {
			...
			(ot(this, t),
				...
				"string" === typeof this.opts.query &&
					(this.opts.query = (function (e) {
						...
						for (let r = 0, o = n.length; r < o; r++) {
							let e = n[r].split("=");
							t[decodeURIComponent(e[0])] = decodeURIComponent(
								e[1],
							);
						}
						return t;
				...
				Et &&
					...
					"localhost" !== this.hostname &&
						...
						Ct.push(this._offlineEventListener))),
		...
		_getWritablePackets() {
			...
			for (let t = 0; t < this.writeBuffer.length; t++) {
				...
				if ((n && (e += at(n)), t > 0 && e > this._maxPayload))
		...
		_onClose(e, t) {
			if (
				...
				if (
					...
					const e = Ct.indexOf(this._offlineEventListener);
					-1 !== e && Ct.splice(e, 1);
				}
	...
	const Nt = "function" === typeof ArrayBuffer,
		...
		Lt =
			"function" === typeof Blob ||
			("undefined" !== typeof Blob &&
				"[object BlobConstructor]" === Ot.call(Blob)),
		zt =
			"function" === typeof File ||
			("undefined" !== typeof File &&
				"[object FileConstructor]" === Ot.call(File));
	function Mt(e) {
		return (
			(Nt &&
				(e instanceof ArrayBuffer ||
			...
			(Lt && e instanceof Blob) ||
			(zt && e instanceof File)
		);
	}
	function At(e, t) {
		if (!e || "object" !== typeof e) return !1;
		if (Array.isArray(e)) {
			for (let t = 0, n = e.length; t < n; t++) if (At(e[t])) return !0;
			return !1;
		}
		if (Mt(e)) return !0;
		if (
			...
			return At(e.toJSON(), !0);
		for (const n in e)
			if (Object.prototype.hasOwnProperty.call(e, n) && At(e[n]))
				return !0;
		return !1;
	}
	function Ft(e) {
	...
	function Dt(e, t) {
		return ((e.data = It(e.data, t)), delete e.attachments, e);
	}
	function It(e, t) {
		if (!e) return e;
		...
		if (Array.isArray(e))
			for (let n = 0; n < e.length; n++) e[n] = It(e[n], t);
	...
	class $t {
		...
		encode(e) {
			return (e.type !== Vt.EVENT && e.type !== Vt.ACK) || !At(e)
		...
		encodeAsString(e) {
			let t = "" + e.type;
			return (
				(e.type !== Vt.BINARY_EVENT && e.type !== Vt.BINARY_ACK) ||
					(t += e.attachments + "-"),
				e.nsp && "/" !== e.nsp && (t += e.nsp + ","),
				null != e.id && (t += e.id),
	...
	class Ht extends Ge {
		...
		add(e) {
			...
			if ("string" === typeof e) {
				...
				const n = t.type === Vt.BINARY_EVENT;
				n || t.type === Vt.BINARY_ACK
					? ((t.type = n ? Vt.EVENT : Vt.ACK),
						(this.reconstructor = new qt(t)),
						0 === t.attachments && super.emitReserved("decoded", t))
					: super.emitReserved("decoded", t);
			} else {
				if (!Mt(e) && !e.base64) throw new Error("Unknown type: " + e);
				if (!this.reconstructor)
					throw new Error(
		...
		decodeString(e) {
			...
			if (n.type === Vt.BINARY_EVENT || n.type === Vt.BINARY_ACK) {
				const r = t + 1;
	...
	class qt {
		...
		takeBinaryData(e) {
			if (
				...
				const e = Dt(this.reconPack, this.buffers);
	...
	class Yt extends Ge {
		...
		emit(e) {
			...
			const l = { type: Vt.EVENT, data: a, options: {} };
			if (
				((l.options.compress = !1 !== this.flags.compress),
				"function" === typeof a[a.length - 1])
			) {
				const e = this.ids++,
					t = a.pop();
				(this._registerAckCallback(e, t), (l.id = e));
			}
			const s =
					null ===
						(n =
		...
		_addToQueue(e) {
			...
			(e.push(function (e) {
				...
				if (null !== e)
					r.tryCount > t._opts.retries &&
						(t._queue.shift(), n && n(e));
			...
			return function () {
				if (!n) {
					...
					for (
						...
						o[a] = arguments[a];
					t.packet({ type: Vt.ACK, id: e, data: o });
				}
			};
		}
		onack(e) {
		...
		constructor(e, t) {
			...
			(super(),
				...
				this.randomizationFactor(
					null !== (n = t.randomizationFactor) && void 0 !== n
						? n
						: 0.5,
				),
				(this.backoff = new Xt({
		...
		socket(e, t) {
			...
			return (
				n
					...
					: ((n = new Yt(this, e, t)), (this.nsps[e] = n)),
				n
			);
		}
		_destroy(e) {
	...
	function Zt(e, t) {
		...
		const n = (function (e) {
			...
			o = n.id,
			a = n.path,
			i = Gt[o] && a in Gt[o].nsps;
		let l;
		return (
			t.forceNew || t["force new connection"] || !1 === t.multiplex || i
				? (l = new Jt(r, t))
				: (Gt[o] || (Gt[o] = new Jt(r, t)), (l = Gt[o])),
			n.query && !t.query && (t.query = n.queryKey),
			l.socket(n.path, t)
		);
	}
	Object.assign(Zt, { Manager: Jt, Socket: Yt, io: Zt, connect: Zt });
	var en = n(579);
	const tn = (0, a.createContext)({ socket: null, isConnected: !1 }),
		nn = (e) => {
			let { children: t } = e;
			...
			return (
				(0, a.useEffect)(() => {
					const e = Zt("http://localhost:3001", {
						transports: ["websocket", "polling"],
					});
					return (
						e.on("connect", () => {
							(console.log("Connected to server:", e.id), i(!0));
						}),
						e.on("disconnect", () => {
							(console.log("Disconnected from server"), i(!1));
						}),
						r(e),
						() => {
							e.close();
				...
				(0, en.jsx)(tn.Provider, {
					value: { socket: n, isConnected: o },
					children: t,
				})
			);
		},
		rn = () => {
			const e = (0, a.useContext)(tn);
			if (!e)
				throw new Error(
	...
	const un = [];
	for (let vn = 0; vn < 256; ++vn) un.push((vn + 256).toString(16).slice(1));
	function cn(e) {
		let t =
	...
	const fn = function (e, t, n) {
		...
		pn = () => {
			const { roomId: e } = oe(),
				{ socket: t } = rn(),
				n = (null === t || void 0 === t ? void 0 : t.id) || fn(),
				r = !0,
				o = (0, a.useRef)(null),
				[i, l] = (0, a.useState)(0),
				[s, u] = (0, a.useState)(!1),
				...
				v = 150,
				b = g.isMyTurn ? g.myRotation : g.opponentRotation;
			((0, a.useEffect)(() => {
				const e = o.current;
				if (!e) return;
					...
					((e, t, n, r, o) => {
						...
						dn.forEach((i, l) => {
							...
							(e.beginPath(),
								...
								e.fillText(i.label, r - 10, 5),
								e.restore());
						});
					})(t, e.width / 2, e.height / 2, v, b));
			}, [b]),
				(0, a.useEffect)(() => {
					if (!t || !e) return;
					(console.log("Joining room:", e), t.emit("join_room", e));
					const o = (e) => {
							console.log("Player joined room:", e);
						},
						a = () => {
							...
							y((t) =>
								Ne(
									...
									{},
									{
										...
										currentTurn: e.turnNumber,
										totalTurns:
											e.remainingTurns + e.turnNumber - 1,
									},
								),
							);
						},
						f = (e) => {
							y((t) =>
								Ne(
									...
									{
										gamePhase: "finished",
										turnHistory: e.finalScore,
									},
								),
							);
						};
					return (
						t.on("player_joined", o),
						t.on("room_not_found", a),
						t.on("room_full", i),
						t.on("game_started", l),
						t.on("rotation_update", s),
						t.on("turn_ended", u),
						t.on("your_turn", c),
						t.on("game_ended", f),
						() => {
							(t.off("player_joined", o),
								t.off("room_not_found", a),
								t.off("room_full", i),
								t.off("game_started", l),
								t.off("rotation_update", s),
								t.off("turn_ended", u),
								t.off("your_turn", c),
								t.off("game_ended", f));
						}
			...
			const w = (e) => {
				...
				k = (e) => {
					...
					if (
						((t.style.cursor =
							f <= v ? (s ? "grabbing" : "grab") : "default"),
						s && g.isMyTurn && "playing" === g.gamePhase)
					) {
						const e = Math.atan2(u, i) - c;
						(l(e), y((t) => Ne(Ne({}, t), {}, { myRotation: e })));
					}
				},
				S = () => u(!1),
				_ =
						...
						children: [
							(0, en.jsx)("canvas", {
								...
								style: {
									...
									borderRadius: "50%",
									cursor:
										g.isMyTurn && "playing" === g.gamePhase
											? "grab"
											: "not-allowed",
									touchAction: "none",
									opacity:
								...
								onClick: (e) => {
									const t = o.current.getBoundingClientRect(),
										...
										a = e.clientX - n,
										l = e.clientY - r;
									if (Math.sqrt(a * a + l * l) > 150)
										return void p(
											"Clicked outside the pie",
										);
									const s =
											(Math.atan2(l, a) -
												i +
												2 * Math.PI) %
											(2 * Math.PI),
										u = (2 * Math.PI) / dn.length,
										c = Math.floor(s / u) % dn.length,
										f = ((180 * i) / Math.PI) % 360;
									p(
										"You clicked: "
											.concat(
					...
					g.isMyTurn &&
						...
						(0, en.jsx)("div", {
							...
							children: (0, en.jsxs)("button", {
								...
								children: ["End Turn (", g.currentTurn, "/6)"],
							}),
						}),
					(0, en.jsxs)("div", {
		...
		hn = () => {
			const { socket: e, isConnected: t } = rn(),
				{
					createRoom: n,
					joinRoom: r,
					isCreatingRoom: o,
					...
					const t = re(),
						{ roomId: n } = oe(),
						[r, o] = (0, a.useState)(n || null),
						[i, l] = (0, a.useState)(!1);
					return {
						currentRoomId: r,
						createRoom: (0, a.useCallback)(() => {
							e &&
								!i &&
								(l(!0),
								e.emit("create_room"),
								e.once("room_created", (e) => {
									(o(e), t("/game/".concat(e)), l(!1));
								}));
						}, [e, t, i]),
						joinRoom: (0, a.useCallback)(
							(n) => {
								e &&
									(e.emit("join_room", n),
									o(n),
			...
			return (0, en.jsxs)("div", {
				...
				children: [
					(0, en.jsx)("h1", {
						children: "Paper Cricket - Multiplayer",
					}),
					(0, en.jsx)("div", {
						style: { margin: "30px 0" },
						children: (0, en.jsx)("button", {
							onClick: n,
							disabled: o,
							style: {
								padding: "15px 30px",
					...
					(0, en.jsxs)("div", {
						...
						children: [
							...
							(0, en.jsx)("p", {
								children:
									"Room creator always takes the first turn.",
							}),
						],
					}),
				],
	...
	const mn = function () {
		return (0, en.jsx)(nn, {
			children: (0, en.jsx)(_e, {
				children: (0, en.jsx)("div", {
					className: "App",
					children: (0, en.jsxs)(we, {
						children: [
							(0, en.jsx)(ve, {
								path: "/",
								element: (0, en.jsx)(hn, {}),
	...
	l.createRoot(document.getElementById("root")).render(
		(0, en.jsx)(a.StrictMode, { children: (0, en.jsx)(mn, {}) }),
	);
})();
//# sourceMappingURL=main.0d297f2a.js.map
